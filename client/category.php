      ...
      <div class="row">
        <div class="col l-12 m-12 c-12 sort">
          <div class="search-control">
            <span style="display: inline-block;text-align:left"><input type="text" placeholder="Tìm kiếm..." class="search-category"></span>
...
<script>
  ...
  searchCategory.oninput = async (e) => {
    ...
    if (data.length == 0) {
      screen.innerHTML = 'Không tìm thấy sản phẩm'
    } else {
      const result = data.map((item, index) => {
        return `
      <div class="product col l-3 m-4 c-12">
