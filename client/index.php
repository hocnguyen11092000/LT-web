...
<body>
  ...
  <main id="main">
    ...
    <div class="wrapper">
      ...
      <h2 class="hot-product">Sản phẩm nổi bật</h2>
      <div class="slider">
      ...
      <div class="grid wide category">
        ...
        <div class="grid wide">
          ...
          <p style="text-align:center" class="load"><a href="#loadMore" onclick="loadMore()" id="load-more">Xem thêm</a></p>
        </div>
      </div>
  ...
  <script>
    ...
    const loadMore = () => {
      ...
      setTimeout(() => {
        ...
        btn = $('#load-more').innerText = 'Xem thêm'
