...
<script>
  ...
  watchOrderDetail.onclick = () => {
    ...
    document.querySelector('.blur_checkout').classList.toggle('active')
  }

  const blur_checkout = document.querySelector('.blur_checkout')

  blur_checkout.onclick = function() {
