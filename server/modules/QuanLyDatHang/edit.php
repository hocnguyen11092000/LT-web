...
<div class="wrapper">
  <h1>Trang sửa trạng thái đơn hàng</h1>
  <div class="form">
    <?php
    ...
    ?>
      <form action="QuanLyDatHang/code.php?id=<?php echo $row['SoDonDH'] ?>" method="POST">
        ...
        <div class="form-group">
          ...
          <select name="trangthaidathang" id="">
            <?php
            if ($row['TrangThaiDH'] == 0) {
              ...
              echo '
              <option selected value="2">Đã bị hủy</option>
              <option value="0">Chưa duyệt</option>
              <option value="1">Đã duyệt</option>
              ';
            }
        ...
        <div class="form-group">
          ...
          <select name="MSNV">
            ...
            $sql_nhanvien = "SELECT * FROM `nhanvien` where HoTenNV = '" . $user . "'";
