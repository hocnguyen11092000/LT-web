...
<main id="main">
  ...
  <h1 class="list-order-heading">Danh sách đơn hàng</h1>
  <div class="tab">
    <div class="tab__list">
      <ul>
          ...
          ?>
            <tr>
              ...
              <td>
                ...
                <a class="print" href="QuanLyDatHang/print-order.php?sddh=<?php echo $row_daduyet['SoDonDH'] ?>&mskh=<?php echo $row_daduyet['MSKH'] ?>">In hóa đơn</a>
              </td>
            </tr>
          <?php
          }
